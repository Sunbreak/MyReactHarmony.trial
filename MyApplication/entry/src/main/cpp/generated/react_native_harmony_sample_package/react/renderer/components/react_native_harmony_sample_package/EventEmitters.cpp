...
void GeneratedSampleViewEventEmitter::onDirectEvent(OnDirectEvent $event) const {
...
void GeneratedSampleViewEventEmitter::onBubblingEvent(OnBubblingEvent $event) const {
...
void GeneratedSampleViewEventEmitter::onReceivedCommandArgs(OnReceivedCommandArgs $event) const {
