...
GeneratedSampleViewProps::GeneratedSampleViewProps(
    const PropsParserContext &context,
    const GeneratedSampleViewProps &sourceProps,
    ...
    stringEnumTest(convertRawProp(context, rawProps, "stringEnumTest", sourceProps.stringEnumTest, {GeneratedSampleViewStringEnumTest::Foo})),
